...
\Cref{tab:tabelle} show the use of \code{threeparttable} which allows using footnotes inside tables. In addition, column style provided by \code{siunitx} is demonstrated.
