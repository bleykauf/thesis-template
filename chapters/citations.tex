...
\end{enumerate}
More rules can be found in the \code{booktabs} documentation.


Table \,\ref{tab:tabelle} show the use of \code{threeparttable} which allows using footnotes inside tables. In addition, column style provided by \code{siunitx} is demonstrated.
