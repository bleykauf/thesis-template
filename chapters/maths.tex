...
\section{Usage of different mathematics environments}
 {\AmS}-{\LaTeX} is a series of document classes and environments for typesetting mathematics. The package \code{mathtools} extends this functionality and contains some fixes.

Eq.\,\ref{eq:equation} is a simple equation,
